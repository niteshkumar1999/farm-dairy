export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-farm-warm via-farm-cream to-red-50">
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-20 right-10 w-72 h-72 bg-red-200 rounded-full blur-3xl" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a
                href="#app"
                className="inline-flex items-center gap-2 bg-farm-red hover:bg-farm-red-dark text-white font-semibold px-7 py-3.5 rounded-full transition-colors shadow-lg shadow-red-900/20"
              >
                Download Our App
              </a>
              <a
                href="#products"
                className="inline-flex items-center gap-2 border-2 border-farm-red text-farm-red hover:bg-farm-red hover:text-white font-semibold px-7 py-3.5 rounded-full transition-colors"
              >
                Explore Products
              </a>
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-xl p-4 hidden sm:block">
              <p className="text-2xl font-bold text-farm-red">1000+</p>
